...
Согласно логам Suricata для данных настроек сканирование не выявлено.
...
1. Настройка hydra.
Создадим файлы на Kali.  
`nano users.txt`  
`nano pass.txt`  

2. Включим защиту SSH для Fail2Ban в файле /etc/fail2ban/jail.conf на атакуемом хосте.

<img src = "img/2-1.png" width = 60%>  

3. Осуществим атаку.  
`hydra -L users.txt -P pass.txt 192.168.65.136 ssh -t 4 -w 10`
...
<img src = "img/3-1.jpeg" width = 60%> 
<img src = "img/3-2.png" width = 60%> 
<img src = "img/3-3.png" width = 60%>

**3.2. С включенным fail2ban.**   
Соединение и сканирование  были сброшены. Ошибка в Kali `[ERROR] all children were disabled due too many connection errors`. 
Suricata  и Fail2ban обнаружили перебор.  

<img src = "img/3-4.jpeg" width = 60%> 
